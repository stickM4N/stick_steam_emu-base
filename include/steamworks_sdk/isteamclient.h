...
// SteamAPI_Init(). 			You'll only need these APIs if you have a more
// complex
...
public:
	...
	// NOT THREADSAFE - ensure that no other threads are accessing Steamworks
	// API when calling
	...
	// used by game servers, create a steam user that won't be shared with
	// anyone else NOT THREADSAFE - ensure that no other threads are accessing
	// Steamworks API when calling
	...
	virtual ISteamMatchmakingServers *
	...
	// game search
	virtual ISteamGameSearch *GetISteamGameSearch(HSteamUser hSteamuser,
	                                              HSteamPipe hSteamPipe,
	                                              const char *pchVersion)
	    = 0;
	...
	// Deprecated - the ISteamUnifiedMessages interface is no longer intended
	...
	// Exposes the ISteamController interface - deprecated in favor of Steam
	// Input
	...
	// inventory
	virtual ISteamInventory *GetISteamInventory(HSteamUser hSteamuser,
	                                            HSteamPipe hSteamPipe,
	                                            const char *pchVersion)
	    = 0;

	// Video
	virtual ISteamVideo *GetISteamVideo(HSteamUser hSteamuser,
	                                    HSteamPipe hSteamPipe,
	                                    const char *pchVersion)
	    = 0;
	...
	virtual ISteamInput *GetISteamInput(HSteamUser hSteamUser,
	                                    HSteamPipe hSteamPipe,
	                                    const char *pchVersion)
	    = 0;

	// Steam Parties interface
	virtual ISteamParties *GetISteamParties(HSteamUser hSteamUser,
	                                        HSteamPipe hSteamPipe,
	                                        const char *pchVersion)
	    = 0;

	// Steam Remote Play interface
	virtual ISteamRemotePlay *GetISteamRemotePlay(HSteamUser hSteamUser,
	                                              HSteamPipe hSteamPipe,
	                                              const char *pchVersion)
	    = 0;
...
// (This is actually the same thing.  You really shouldn't need to access any of
// this stuff directly.)
