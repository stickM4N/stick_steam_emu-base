...
#if (defined(STEAM_API_EXPORTS) || defined(STEAM_API_NODLL))                   \
    && !defined(API_GEN)
...
extern "C" typedef void(__cdecl *SteamAPIWarningMessageHook_t)(int,
                                                               const char *);
extern "C" typedef uint32 (*SteamAPI_CheckCallbackRegistered_t)(
    int iCallbackNum);
#if defined(__SNC__)
#	pragma diag_suppress = 1700   // warning 1700: class "%s" has virtual
...
public:
	...
	// NOTE: If you can't provide the correct parameters at construction time,
	// you should use the CCallbackManual callback object (STEAM_CALLBACK_MANUAL
	// macro) instead.
