...
S_API ISteamFriends *SteamAPI_ISteamClient_GetISteamFriends(
    ISteamClient *self, HSteamUser hSteamUser, HSteamPipe hSteamPipe,
    const char *pchVersion);
S_API ISteamUtils *SteamAPI_ISteamClient_GetISteamUtils(ISteamClient *self,
                                                        HSteamPipe hSteamPipe,
                                                        const char *pchVersion);
...
S_API ISteamAppList *SteamAPI_ISteamClient_GetISteamAppList(
    ISteamClient *self, HSteamUser hSteamUser, HSteamPipe hSteamPipe,
    const char *pchVersion);
S_API ISteamMusic *SteamAPI_ISteamClient_GetISteamMusic(ISteamClient *self,
                                                        HSteamUser hSteamuser,
                                                        HSteamPipe hSteamPipe,
                                                        const char *pchVersion);
...
S_API ISteamInventory *SteamAPI_ISteamClient_GetISteamInventory(
    ISteamClient *self, HSteamUser hSteamuser, HSteamPipe hSteamPipe,
    const char *pchVersion);
S_API ISteamVideo *SteamAPI_ISteamClient_GetISteamVideo(ISteamClient *self,
                                                        HSteamUser hSteamuser,
                                                        HSteamPipe hSteamPipe,
                                                        const char *pchVersion);
S_API ISteamParentalSettings *SteamAPI_ISteamClient_GetISteamParentalSettings(
    ISteamClient *self, HSteamUser hSteamuser, HSteamPipe hSteamPipe,
    const char *pchVersion);
S_API ISteamInput *SteamAPI_ISteamClient_GetISteamInput(ISteamClient *self,
                                                        HSteamUser hSteamUser,
                                                        HSteamPipe hSteamPipe,
                                                        const char *pchVersion);
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamUser(), but using this ensures that you are using a matching
// library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamFriends(), but using this ensures that you are using a matching
// library.
...
S_API const char *SteamAPI_ISteamFriends_GetClanTag(ISteamFriends *self,
                                                    uint64_steamid steamIDClan);
...
S_API SteamAPICall_t SteamAPI_ISteamFriends_JoinClanChatRoom(
    ISteamFriends *self, uint64_steamid steamIDClan);
S_API bool SteamAPI_ISteamFriends_LeaveClanChatRoom(ISteamFriends *self,
                                                    uint64_steamid steamIDClan);
S_API int
...
S_API SteamAPICall_t SteamAPI_ISteamFriends_IsFollowing(ISteamFriends *self,
                                                        uint64_steamid steamID);
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamUtils(), but using this ensures that you are using a matching
// library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServerUtils(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamMatchmaking(), but using this ensures that you are using a
// matching library.
...
SteamAPI_ISteamMatchmaking_GetLobbyByIndex(ISteamMatchmaking *self, int iLobby);
...
S_API bool
SteamAPI_ISteamMatchmaking_SetLinkedLobby(ISteamMatchmaking *self,
                                          uint64_steamid steamIDLobby,
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamMatchmakingServers(), but using this ensures that you are using
// a matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameSearch(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamParties(), but using this ensures that you are using a matching
// library.
...
S_API void SteamAPI_ISteamParties_CancelReservation(ISteamParties *self,
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamRemoteStorage(), but using this ensures that you are using a
// matching library.
...
S_API SteamAPICall_t SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation(
    ...
    uint32 unPriority);
S_API int32
SteamAPI_ISteamRemoteStorage_GetLocalFileChangeCount(ISteamRemoteStorage *self);
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamUserStats(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamApps(), but using this ensures that you are using a matching
// library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamNetworking(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServerNetworking(), but using this ensures that you are
// using a matching library.
...
S_API bool
SteamAPI_ISteamNetworking_ReadP2PPacket(ISteamNetworking *self, void *pubDest,
...
S_API bool
SteamAPI_ISteamNetworking_CloseP2PSessionWithUser(ISteamNetworking *self,
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamScreenshots(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamMusic(), but using this ensures that you are using a matching
// library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamMusicRemote(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamHTTP(), but using this ensures that you are using a matching
// library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServerHTTP(), but using this ensures that you are using a
// matching library.
...
S_API bool SteamAPI_ISteamHTTP_SetHTTPRequestUserAgentInfo(
    ISteamHTTP *self, HTTPRequestHandle hRequest, const char *pchUserAgentInfo);
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamInput(), but using this ensures that you are using a matching
// library.
...
S_API const char *
SteamAPI_ISteamInput_GetGlyphForActionOrigin_Legacy(ISteamInput *self,
...
S_API void SteamAPI_ISteamInput_Legacy_TriggerRepeatedHapticPulse(
    ISteamInput *self, InputHandle_t inputHandle,
    ESteamControllerPad eTargetPad, unsigned short usDurationMicroSec,
    unsigned short usOffMicroSec, unsigned short unRepeat, unsigned int nFlags);
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamController(), but using this ensures that you are using a
// matching library.
...
S_API bool
SteamAPI_ISteamController_ShowBindingPanel(ISteamController *self,
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamUGC(), but using this ensures that you are using a matching
// library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServerUGC(), but using this ensures that you are using a
// matching library.
...
S_API SteamAPICall_t SteamAPI_ISteamUGC_RequestUGCDetails(
    ...
    uint32 unMaxAgeSeconds);
S_API SteamAPICall_t SteamAPI_ISteamUGC_CreateItem(ISteamUGC *self,
...
S_API bool SteamAPI_ISteamUGC_SetItemVisibility(
    ...
    ERemoteStoragePublishedFileVisibility eVisibility);
S_API bool SteamAPI_ISteamUGC_SetItemTags(ISteamUGC *self,
...
S_API bool SteamAPI_ISteamUGC_UpdateItemPreviewFile(ISteamUGC *self,
                                                    UGCUpdateHandle_t handle,
                                                    uint32 index,
                                                    const char *pszPreviewFile);
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamAppList(), but using this ensures that you are using a matching
// library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamHTMLSurface(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamInventory(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServerInventory(), but using this ensures that you are using
// a matching library.
...
S_API bool
SteamAPI_ISteamInventory_GrantPromoItems(ISteamInventory *self,
                                         SteamInventoryResult_t *pResultHandle);
S_API bool
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamVideo(), but using this ensures that you are using a matching
// library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamParentalSettings(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamRemotePlay(), but using this ensures that you are using a
// matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamNetworkingMessages_SteamAPI(), but using this ensures that you
// are using a matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServerNetworkingMessages_SteamAPI(), but using this ensures
// that you are using a matching library.
inline ISteamNetworkingMessages *
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamNetworkingSockets_SteamAPI(), but using this ensures that you
// are using a matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServerNetworkingSockets_SteamAPI(), but using this ensures
// that you are using a matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamNetworkingUtils_SteamAPI(), but using this ensures that you are
// using a matching library.
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServer(), but using this ensures that you are using a
// matching library.
...
S_API int
SteamAPI_ISteamGameServer_GetNextOutgoingPacket(ISteamGameServer *self,
                                                void *pOut, int cbMaxOut,
...
// Inline, unversioned accessor to get the current version.  Essentially the
// same as SteamGameServerStats(), but using this ensures that you are using a
// matching library.
